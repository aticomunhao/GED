            ...
            <div class="row">
                <div class="form-group">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group">
                        ...
                        <input id = "minimo" name = "minimo" class = "form-control" required type = "number" value = "<?= set_value('minimo') ?>">
                        <?= form_error('minimo'); ?>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 form-group">
                        ...
                        <input id = "maximo" name = "maximo" class = "form-control" required type = "number" value = "<?= set_value('maximo') ?>">
                        <?= form_error('maximo'); ?>
                    </div>
                </div>
            </div>
